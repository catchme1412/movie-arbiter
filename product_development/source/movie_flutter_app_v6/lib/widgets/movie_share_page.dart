...
class MovieSharePage extends StatefulWidget {
  ...
  const MovieSharePage({Key key, this.sharedData}) : super(key: key);

  @override
  _MovieSharePageState createState() => _MovieSharePageState(sharedData);
}
...
class _MovieSharePageState extends State<MovieSharePage> {
  ...
  _MovieSharePageState(this.sharedData);
...
//              child: Image.asset("assets/images/share-4.png"),
//            ),
//            Text(widget.sharedData.values.elementAt(1).toString()),
//          ],
////              child: Text(
//////                  "FFF" + widget.sharedData.values.elementAt(1).toString())),
//        ),
//      ),
//    );
  }
